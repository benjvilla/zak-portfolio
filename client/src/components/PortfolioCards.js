          ...
          <div className="col">
            ...
            <Card className="individualCard">
              ...
              <Card.Body>
                ...
                <Card.Text>
                  I currently the University of Louisville and I am working
                  towards my B.S Organizational Leadership and Learning with a
                  minor in Leadership and Talent Development and undergraduate
                  certificate in Human Resources Leadership. I will graduate in
                  May 2022.
                </Card.Text>
                <Accordion defaultActiveKey="0">
                  <Accordion.Item eventKey="1">
                    <Accordion.Header>
                      Below are the final projects during my tenure
                    </Accordion.Header>
                    <Accordion.Body>
                      <Card.Img
                        variant="top"
            ...
            <Card className="individualCard">
              ...
              <Card.Body>
                ...
                <Card.Text>
                  As a group of 4 we were assigned a brand redesign for a DTC
                  coffee company. Original site had little branding and a
                  grayscale user interface. We then had to present to the client
                  our solutions. Full presentation deck, video of click through,
                  and user research and personas were built to inform the design
                  for the company. I was our design system manager, so role was
                  to build out the entire design system our Lead Designer would
                  use to build out the high fidelity mockups.
                </Card.Text>
                <Accordion defaultActiveKey="0">
                  <Accordion.Item eventKey="1">
                    <Accordion.Header>Placeholder text</Accordion.Header>
